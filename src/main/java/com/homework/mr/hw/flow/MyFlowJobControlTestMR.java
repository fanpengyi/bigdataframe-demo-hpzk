...
public class MyFlowJobControlTestMR {
    ...
    public static void main(String[] args) throws Exception {
       ...
       // conf1.addResource("hadoop_ha_config/hdfs-site.xml");
        ...
        jobsum.setJarByClass(MyFlowJobControlTestMR.class);
        ...
        jobsort.setJarByClass(MyFlowJobControlTestMR.class);
        ...
        // 告诉框架，我们的处理结果要输出到哪里去
        Path outputPath2 = new Path("./mrdata/flow/output3_sort_many");
