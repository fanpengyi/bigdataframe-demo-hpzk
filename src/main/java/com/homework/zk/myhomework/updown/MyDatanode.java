...
public class MyDatanode {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	zk = new ZooKeeper(MyOwnConstant.CONNECT_ZK, MyOwnConstant.TIME_OUT, null);
    ...
    public static void upServer() throws KeeperException, InterruptedException {
		String str = zk.create(MyOwnConstant.UPDOWN_CHILD_NODE + index, "服务器".getBytes(), Ids.OPEN_ACL_UNSAFE,
				CreateMode.PERSISTENT);
		System.out.println(str + "上线成功");
	}

	public static void downServer() throws KeeperException, InterruptedException {
		String path = MyOwnConstant.UPDOWN_CHILD_NODE+ index;
		zk.delete(path, -1);
